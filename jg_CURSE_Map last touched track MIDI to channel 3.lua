-- jg_CURSE_MapLastTouchedTrackMIDIToChannel3.lua
-- Set "Map input to channel" to MIDI Channel 3 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 2 -- channel 3 -> 2
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 3", -1)
