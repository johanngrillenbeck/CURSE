-- jg_CURSE_MapLastTouchedTrackMIDIToChannel5.lua
-- Set "Map input to channel" to MIDI Channel 5 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 4 -- channel 5 -> 4
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 5", -1)
