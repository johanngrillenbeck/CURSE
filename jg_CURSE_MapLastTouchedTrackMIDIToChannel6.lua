-- jg_CURSE_MapLastTouchedTrackMIDIToChannel6.lua
-- Set "Map input to channel" to MIDI Channel 6 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 5 -- channel 6 -> 5
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 6", -1)
