-- jg_CURSE_MapLastTouchedTrackMIDIToChannel7.lua
-- Set "Map input to channel" to MIDI Channel 7 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 6 -- channel 7 -> 6
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 7", -1)
