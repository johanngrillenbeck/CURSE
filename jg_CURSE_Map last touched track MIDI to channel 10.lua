-- jg_CURSE_MapLastTouchedTrackMIDIToChannel10.lua
-- Set "Map input to channel" to MIDI Channel 10 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 9 -- channel 10 -> 9
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 10", -1)
