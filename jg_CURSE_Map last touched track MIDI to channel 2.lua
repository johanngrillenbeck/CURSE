-- jg_CURSE_MapLastTouchedTrackMIDIToChannel2.lua
-- Set "Map input to channel" to MIDI Channel 2 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 1 -- channel 2 -> 1
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 2", -1)
