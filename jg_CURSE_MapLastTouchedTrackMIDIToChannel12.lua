-- jg_CURSE_MapLastTouchedTrackMIDIToChannel12.lua
-- Set "Map input to channel" to MIDI Channel 12 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 11 -- channel 12 -> 11
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 12", -1)
