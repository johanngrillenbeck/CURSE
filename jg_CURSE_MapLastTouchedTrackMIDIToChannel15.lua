-- jg_CURSE_MapLastTouchedTrackMIDIToChannel15.lua
-- Set "Map input to channel" to MIDI Channel 15 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 14 -- channel 15 -> 14
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 15", -1)
