-- jg_CURSE_MapLastTouchedTrackMIDIToChannel13.lua
-- Set "Map input to channel" to MIDI Channel 13 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 12 -- channel 13 -> 12
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 13", -1)
