-- jg_CURSE_MapLastTouchedTrackMIDIToChannel8.lua
-- Set "Map input to channel" to MIDI Channel 8 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 7 -- channel 8 -> 7
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 8", -1)
