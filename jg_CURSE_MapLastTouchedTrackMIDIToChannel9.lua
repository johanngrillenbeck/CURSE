-- jg_CURSE_MapLastTouchedTrackMIDIToChannel9.lua
-- Set "Map input to channel" to MIDI Channel 9 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 8 -- channel 9 -> 8
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 9", -1)
