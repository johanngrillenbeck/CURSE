-- jg_CURSE_MapLastTouchedTrackMIDIToChannel4.lua
-- Set "Map input to channel" to MIDI Channel 4 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 3 -- channel 4 -> 3
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 4", -1)
