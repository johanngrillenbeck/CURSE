-- jg_CURSE_MapLastTouchedTrackMIDIToChannel11.lua
-- Set "Map input to channel" to MIDI Channel 11 on the last-touched track
-- Author: jg
-- Version: 0.1
...
local target_zero_based = 10 -- channel 11 -> 10
...
if not setok then
  r.Undo_EndBlock("Map last-touched track input to MIDI channel 11", -1)
